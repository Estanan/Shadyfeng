    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, R.string.errcheckPermission,
...
//            navigationView.getMenu().findItem(R.id.nav_about).setIcon(R.drawable.information);
            navigationView.getMenu().findItem(R.id.login).setIcon(R.drawable.information);
...
//            navigationView.getMenu().findItem(R.id.nav_about).setIcon(R.drawable.information_white);
        ...
        if (username!=null){
            navigationView.getMenu().findItem(R.id.login).setTitle(username);
            navigationView.getMenu().findItem(R.id.login).setIcon(R.drawable.icon);
        }
    }
...
//                break;
            case R.id.login:
                ...
                if(username==null){
                    chooseIntent=new Intent(this, ChooseLogActivity.class);
                    startActivity(chooseIntent);
                }else {
//                    chooseIntent=new Intent(this,RegestActivity.class);
                    NavigationUtils.navigateToUserInfor(MainActivity.this);
