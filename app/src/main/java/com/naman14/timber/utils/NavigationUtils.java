...
import com.naman14.timber.activities.UserInforActivity;
...
public class NavigationUtils {
    ...
    public static void navigateToUserInfor(Activity context){
        final Intent intent=new Intent(context,UserInforActivity.class);
        context.startActivity(intent);
    }
