...
public class UserSongListAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    private String[] Queuelist={"全部歌曲","最近添加","我喜欢的"};

    public UserSongListAdapter(Context context, List<Integer> datas) {
        this.datas = datas;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (position<3){
            holder.mTextView.setText(position+Queuelist[position].toString());
        }else {
